...
import (
	...
	"github.com/arneph/toph/builder/packages/internal/x/tools/lsp/foo" //@link(`github.com/arneph/toph/builder/packages/internal/x/tools/lsp/foo`,`https://pkg.go.dev/github.com/arneph/toph/builder/packages/internal/x/tools/lsp/foo`)
