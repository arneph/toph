...
import (
	myFoo "github.com/arneph/toph/builder/packages/internal/x/tools/lsp/foo" //@mark(myFoo, "myFoo"),godef("myFoo", myFoo)
	"github.com/arneph/toph/builder/packages/internal/x/tools/lsp/godef/a"   //@mark(AImport, re"\".*\"")
)
